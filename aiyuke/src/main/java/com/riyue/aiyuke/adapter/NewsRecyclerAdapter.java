...
public class NewsRecyclerAdapter extends RecyclerView.Adapter implements View.OnClickListener{
    ...
    private List<NewsTechInfo.MsgEntity.NewsListEntity> dataList;
    ...
    public NewsRecyclerAdapter(Context context, List<NewsTechInfo.MsgEntity.NewsListEntity> dataList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        NewsTechInfo.MsgEntity.NewsListEntity entity = dataList.get(position);
...
//        return super.getItemViewType(position);
    ...
    public void onClick(View v) {
        if (mOnItemClickListener != null) {
            //注意这里使用getTag方法获取数据
            mOnItemClickListener.onItemClick(v, (NewsTechInfo.MsgEntity.NewsListEntity) v.getTag());
        }
    }
    ...
    public static interface OnRecyclerViewItemClickListener {
        void onItemClick(View view , NewsTechInfo.MsgEntity.NewsListEntity data);
    }
